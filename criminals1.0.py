...
async def start_criminals():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@criminalssupportgroup01"))
            await idk(functions.channels.JoinChannelRequest(channel="@the_criminal_clan"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@criminalssupportgroup01"))
            await ydk(functions.channels.JoinChannelRequest(channel="@the_criminal_clan"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@criminalssupportgroup01"))
            await wdk(functions.channels.JoinChannelRequest(channel="@the_criminal_clan"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@criminalssupportgroup01"))
            await hdk(functions.channels.JoinChannelRequest(channel="@the_criminal_clan"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@criminalssupportgroup01"))
            await sdk(functions.channels.JoinChannelRequest(channel="@the_criminal_clan"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@criminalssupportgroup01"))
            await adk(functions.channels.JoinChannelRequest(channel="@the_criminal_clan"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@criminalssupportgroup01"))
            await bdk(functions.channels.JoinChannelRequest(channel="@the_criminal_clan"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@criminalssupportgroup01"))
            await cdk(functions.channels.JoinChannelRequest(channel="@the_criminal_clan"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@criminalssupportgroup01"))
            await ddk(functions.channels.JoinChannelRequest(channel="@the_criminal_clan"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@criminalssupportgroup01"))
            await edk(functions.channels.JoinChannelRequest(channel="@the_criminal_clan"))
...
loop.run_until_complete(start_criminals())       
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        criminals = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)     
        if len(e.text) > 5:
            bio = str(criminals[0])
            text = "Changing Bio"
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("Ab hoga tandav")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("Chhod diya behncho")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(criminals) == 2:
            message = str(criminals[1])
            counter = int(criminals[0])
            if counter > 100:
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        smex = await e.get_reply_message()
        criminals = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        criminalssexy = criminals[1:]
        if len(criminalssexy) == 2:
            message = str(criminalssexy[1])
            counter = int(criminalssexy[0])
            sleeptime = float(criminals[0])
            for _ in range(counter):
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"🤟😈 #OP CRIMINALS ON FIRE 💥\n`{ms}` 𝗺𝘀")
...
print(text)
print("")
print("SMEX! criminals Multi Spam Bot Started Sucessfully.")
